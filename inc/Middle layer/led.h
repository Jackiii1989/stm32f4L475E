...
// my definition
#define PIN_14                ((uint32_t)	14)  /* Pin 14 selected   */
#define PIN_5                 ((uint32_t)	5 )  /* Pin 5 selected   */
#define PIN_13                ((uint32_t)	13)  /* Pin 13 selected   */
...
typedef struct
{
  ...
  volatile uint16_t BS;          /*!< GPIO port bit set/reset  register,     Address offset: 0x18      */
	volatile uint16_t BR;          /*!< GPIO port bit set/reset  register,     Address offset: 0x20      */
...
__STATIC_INLINE void gpio_init_pin				(GPIO_init_struct* pin);
